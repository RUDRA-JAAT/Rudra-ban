...
Owner = "RUDRA-PIKU"
repo = "https://github.com/RUDRA-JAAT/Rudra-ban"
...
async def start(event):
    ...
    if event.sender.id not in SEXY:
        await event.reply(
            "This is not for you babe!\n\nMake your own bot from this [Repository](https://github.com/RUDRA-JAAT/Rudra-ban)",
            link_preview=False,
        )       
...
print("Join @RUDRA_JAAT if you facing any kind of issue!!")
